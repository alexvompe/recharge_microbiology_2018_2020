...
mortality_acr = na.omit(mortality_acr)
mortality_plob = na.omit(mortality_plob)
mortality_pver = na.omit(mortality_pver)
...
ggsave(plot=p, filename="all corals mortality and bleaching.tiff", scale=2,
